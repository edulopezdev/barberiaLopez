<template>
  <div class="formulario-cliente usuario-form">
    ...
    <div class="campo" :class="{ error: errores.rolId }">
    ...
    <!-- No hay checkbox ni campo password -->
...
export default {
  ...
  data() {
    return {
      form: {
        ...
        telefono: "",
        rolId: null,
        // accedeAlSistema eliminado para que no se toque
      },
      roles: [
  ...
  methods: {
    ...
    validarFormulario() {
      this.errores = { nombre: null, email: null, telefono: null, rolId: null };
      let valido = true;
